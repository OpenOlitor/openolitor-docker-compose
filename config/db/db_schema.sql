...
DROP USER IF EXISTS 'dbusercsa1'@'172.16.0.4';
DROP USER IF EXISTS 'dbusercsa1_ReadOnlyUser'@'%';
DROP USER IF EXISTS 'dbusercsa1_AdminUser'@'%';

CREATE USER 'dbusercsa1'@'172.16.0.4' IDENTIFIED BY 'thisDefaultUserPasswordMustBeChanedInProduction' REQUIRE NONE;
CREATE USER 'dbusercsa1_ReadOnlyUser'@'%' IDENTIFIED BY 'thisDefaultUserPasswordMustBeChanedInProduction' REQUIRE SSL;
CREATE USER 'dbusercsa1_AdminUser'@'%' IDENTIFIED BY 'thisDefaultUserPasswordMustBeChanedInProduction' REQUIRE SSL;

GRANT USAGE ON `csa1`.* TO 'dbusercsa1'@'172.16.0.4';
GRANT ALL privileges ON `csa1`.* TO 'dbusercsa1'@'172.16.0.4';
GRANT USAGE ON `csa1`.* TO 'dbusercsa1_AdminUser'@'%';
GRANT ALL privileges ON `csa1`.* TO 'dbusercsa1_AdminUser'@'%';
GRANT SELECT ON `csa1`.* TO 'dbusercsa1_ReadOnlyUser'@'%';
FLUSH PRIVILEGES;
...
CREATE OR REPLACE VIEW csa1.journal_view AS
